...
type GreetServiceClient interface {
	...
	SayHelloClientStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, MassageList], error)
...
func (c *greetServiceClient) SayHelloClientStream(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, MassageList], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], GreetService_SayHelloClientStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[HelloRequest, MassageList]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloClientStreamClient = grpc.ClientStreamingClient[HelloRequest, MassageList]
...
type GreetServiceServer interface {
	...
	SayHelloClientStream(grpc.ClientStreamingServer[HelloRequest, MassageList]) error
...
func (UnimplementedGreetServiceServer) SayHelloClientStream(grpc.ClientStreamingServer[HelloRequest, MassageList]) error {
...
func _GreetService_SayHelloClientStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).SayHelloClientStream(&grpc.GenericServerStream[HelloRequest, MassageList]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type GreetService_SayHelloClientStreamServer = grpc.ClientStreamingServer[HelloRequest, MassageList]
